...
export class SalesContractService {
  ...
  async createSalesContract(createSalesContractDto: SalesContractDto) {
    return this.salesContractRepository.createSalesContract(
  ...
  async updateSalesContract(
    ...
    return this.salesContractRepository.updateSalesContract(
      id,
  ...
  async getSalesContractDetail(userID: string, salesContractID: string) {
    return this.salesContractRepository.getSalesContractDetail(
      userID,
      salesContractID
    );
  }
  async approveSalesContract(userID: string, salesContractID: string) {
    return this.salesContractRepository.approveSalesContract(
      userID,
      salesContractID
    );
  }
  async rejectSalesContract(
    ...
    return this.salesContractRepository.rejectSalesContract(
      userID,
      salesContractID,
      reason
    );
  ...
  async deleteSalesContract(userID: string, salesContractID: string) {
    return this.salesContractRepository.deleteSalesContract(
      userID,
      salesContractID
    );
  }
